...
In working on this project, I used AI to help fix all the little issues I was encountering. I used it to maek sure that I can use certain data from my HMTL so the JS would know what HTML to use

I also used it to make all the css classes to help make it easy to finish all the css I wanted for looks of the simple site
